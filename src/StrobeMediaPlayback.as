...
{	
	...
	public class StrobeMediaPlayback extends Sprite
	{
		...
		{	
			super();
			var sUsername:String = "kris";
			var sPassword:String = "kris";
			
			// send the credentials string to FMS
			//nc.connect("rtmpe://ec2-75-101-188-8.compute-1.amazonaws.com", {username:sUsername, password:sPassword });
		 ...
		 */ 
		 ...
		 /*public function callAS():void {
			 trace("callAS");
			 var mytxt:String = "FUNIMATION";
			 ExternalInterface.call("videourl",mytxt);
			 return;
		}*/
