...
package org.osmf.player.chrome.widgets
{
	...
	public class TimeViewWidget extends Widget
	{
		...
		{	
			//trace(currentTimePosition+"my time is coming")
			...
			{				
				...
				/*if(currentTimeString==(" 0:10 ")){
					//trace(currentTimeString+"my time is testing inside if")
					gettoken()
				}*/
	  ...
	  /*private function gettoken():void
		 {
			...
			myTextLoader.load(new URLRequest("http://ec2-50-16-182-183.compute-1.amazonaws.com/api/restler/token/index.php/token.xml"));
